...
<xsl:template name="cell">
    ...
    <xsl:variable name="match" select="key('byte-key', $cell_hex)"/>
    ...
    <xsl:choose>
        ...
        <xsl:when test="(not(key('uni-key', $match/@u)))
